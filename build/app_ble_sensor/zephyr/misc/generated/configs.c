...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_EVT_RX_COUNT, 35);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_TX_COUNT, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_GYRO_ODR, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_ACCEL_FS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM6DSL_ACCEL_ODR, 3);
